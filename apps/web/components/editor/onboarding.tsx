  ...
  const steps: Step[] = useMemo(() => [
    {
      ...
      title: t("stepLayersTitle"),
      body: t("stepLayersBody"),
      placement: "right",
    },
    {
      id: "states",
      selector: '[data-tour-id="states-panel"]',
      title: t("stepStatesTitle"),
      body: t("stepStatesBody"),
      placement: "right",
    },
    {
      id: "canvas",
      selector: '[data-tour-id="canvas"]',
      title: t("stepCanvasTitle"),
      body: t("stepCanvasBody"),
      placement: "bottom",
    },
    {
      id: "inspector",
      selector: '[data-tour-id="inspector"]',
      title: t("stepInspectorTitle"),
      body: t("stepInspectorBody"),
      placement: "left",
    },
    {
      id: "settings",
      selector: '[data-tour-id="settings-button"]',
      title: t("stepSettingsTitle"),
      body: t("stepSettingsBody"),
      placement: "bottom",
    },
  ], [t]);
    ...
    <div className="fixed inset-0 z-50 pointer-events-none">
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <Button variant="outline" size="sm" onClick={goPrev}>{t("previous")}</Button>
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" onClick={isLast ? finish : goNext}>{isLast ? t("finish") : t("next")}</Button>
          </div>
        </div>
      </div>
    </div>
