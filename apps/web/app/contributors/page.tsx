        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center space-y-6 mb-16">
              ...
              {/* Title */}
              <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-foreground">{t("title")}</h1>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-8 pt-8">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm text-muted-foreground">{t("contributions")}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {contributors.length === 0 && (
              <div className="text-center py-16">
                ...
                <h3 className="font-heading text-xl font-semibold text-foreground mb-2">{t("unableToLoad")}</h3>
            ...
            <div className="text-center mt-16 p-8 bg-muted/30 rounded-2xl">
              <h2 className="font-heading text-2xl font-bold text-foreground mb-4">{t("wantToContribute")}</h2>
