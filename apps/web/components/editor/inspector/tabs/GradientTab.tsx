...
export function GradientTab({
  ...
  const { t } = useTranslations("gradientTab");
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-1">
        ...
        <Select value={(selected as any).gradientType || 'axial'}
          ...
          <SelectContent>
            <SelectItem value="axial">{t("axialLinear")}</SelectItem>
      ...
      {/* Start Point */}
      <div className="space-y-1">
        <Label htmlFor="startPointX">{t("startPointX")}</Label>
      ...
      <div className="space-y-1">
        <Label htmlFor="startPointY">{t("startPointY")}</Label>
        <div className="flex items-center gap-2 w-full">
          <Slider
            id="startPointY"
      ...
      {/* End Point */}
      <div className="space-y-1">
        <Label htmlFor="endPointX">{t("endPointX")}</Label>
        <div className="flex items-center gap-2 w-full">
          <Slider
            id="endPointX"
      ...
      <div className="space-y-1">
        <Label htmlFor="endPointY">{t("endPointY")}</Label>
        <div className="flex items-center gap-2 w-full">
          <Slider
            id="endPointY"
