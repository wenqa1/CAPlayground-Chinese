...
export default function AuthPage() {
  ...
  const { t: ts } = useTranslations("signup");
            ...
            <CardContent>
              <div className="space-y-5">
                <p className="text-sm text-muted-foreground">
                  {t("signInDisabledDescription")}
                </p>
                <p className="text-sm text-muted-foreground">
                  {t("signInDisabledDescription2")}
                </p>
                <div className="flex gap-3">
                  ...
                  <Link href="/docs">
                    <Button variant="outline">{t("docs")}</Button>
                  </Link>
                </div>
              </div>
            </CardContent>
  ...
  async function handleSignIn() {
    ...
    try {
      ...
      setError(e.message ?? t("errorInvalid"));
    } finally {
      setLoading(false);
    }
  }
  ...
  async function handleSignUp() {
    ...
    try {
      if (!isValidUsername(signupUsername)) {
        throw new Error(ts("usernameHint"));
      }
      ...
      setError(e.message ?? ts("errorGeneric"));
    } finally {
      setLoading(false);
    }
  }
            ...
            {mode === "signin" ? (
              <div className="space-y-5">
                <div className="space-y-2">
                  <Label htmlFor="signin-identifier">{t("emailLabel")}</Label>
              ...
              <div className="space-y-5">
                <div className="space-y-2">
                  <Label htmlFor="signup-username">{ts("usernameLabel")}</Label>
                  <div className="relative">
                ...
                <div className="space-y-2">
                  <Label htmlFor="signup-email">{ts("emailLabel")}</Label>
                  <div className="relative">
                    <AtSign className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                    <Input
                      id="signup-email"
                ...
                <div className="space-y-2">
                  <Label htmlFor="signup-password">{ts("passwordLabel")}</Label>
                  <div className="relative">
                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                    <Input
                      id="signup-password"
                ...
                <Button
                  ...
                  className="w-full bg-accent hover:bg-accent/90 text-accent-foreground font-semibold"
                >
                  {loading ? ts("signingUp") : ts("signUpButton")}
                </Button>
